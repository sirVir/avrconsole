...
#define TS_BOTTOM(DIR) SET(DDRA,_BV(PA1),DIR)
#define TS_LEFT(DIR) SET(DDRA,_BV(PA2),DIR)
#define TS_TOP(DIR) SET(DDRA,_BV(PA3),DIR)
#define TS_RIGHT(DIR) SET(DDRA,_BV(PA4),DIR)

#define TS_BOTTOM_PULLUP(STATE) SET(PORTA,_BV(PA1),STATE)
#define TS_LEFT_PULLUP(STATE) SET(PORTA,_BV(PA2),STATE)
#define TS_TOP_PULLUP(STATE) SET(PORTA,_BV(PA3),STATE)
#define TS_RIGHT_PULLUP(STATE) SET(PORTA,_BV(PA4),STATE)
